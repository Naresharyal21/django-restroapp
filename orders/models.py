...
class OrderItem(models.Model):
    ...
    menu_item = models.ForeignKey( MenuItems, on_delete=models.PROTECT, related_name="order_items")
    price = models.PositiveIntegerField()
    quantity = models.PositiveIntegerField(default=1)
    status = models.CharField(choices=ITEM_STATUS, max_length=2, default=ITEM_STATUS.PREPARING)
    priority = models.CharField(choices= MenuItems.PRIORITY_CHOICES, default= MenuItems.PRIORITY_CHOICES.MEDIUM, max_length=2)
